...
public class FreeDrawSerializableState implements Serializable {
    ...
    public FreeDrawSerializableState(ArrayList<HistoryPath> canceledPaths, ArrayList<HistoryPath> paths, int paintColor,
            int paintAlpha, float paintWidth, ResizeBehaviour resizeBehaviour, int lastW, int lastH) {
